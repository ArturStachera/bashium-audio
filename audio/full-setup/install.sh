...
echo ""
echo "==========================================="
echo "Step 1/6: Realtime Audio"
echo "==========================================="
"$(dirname "$0")/../realtime/install.sh"

echo ""
echo "==========================================="
echo "Step 2/6: Kernel Parameters"
echo "==========================================="
"$(dirname "$0")/../kernel/install.sh"

echo ""
echo "==========================================="
echo "Step 3/6: Sysctl Configuration"
echo "==========================================="
"$(dirname "$0")/../sysctl/install.sh"

echo ""
echo "==========================================="
echo "Step 4/6: CPU Governor"
echo "==========================================="
"$(dirname "$0")/../governor/install.sh"

echo ""
echo "==========================================="
echo "Step 5/6: PipeWire"
echo "==========================================="
"$(dirname "$0")/../pipewire/install.sh"

echo ""
echo "==========================================="
echo "Step 6/6: Audio Packages"
echo "==========================================="
